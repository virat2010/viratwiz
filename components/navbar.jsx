...
function Navbar() {
  return (<nav className="bg-white px-2 sm:px-4 py-2.5 transition-colors dark:bg-gray-900 fixed w-full z-20 top-0 left-0 border-b border-gray-200 dark:border-gray-600">
    <div className="container flex flex-wrap justify-between items-center mx-auto">
      <a href="https://viratwiz.com/" className="flex items-center hover:no-underline">
        ...
        <span className="self-center text-xl font-semibold whitespace-nowrap text-black hover:text-sky-600 dark:text-white">
          Viratwiz
        </span>
      </a>
...
function NavElement({
  ...
  return (<li className={props + "py-2 pr-4 pl-4 rounded md:bg-transparent md:text-white md:p-0"
    ...
    <Link href={href} className="hover:no-underline">
      <p className="hover:text-sky-600 dark:text-white text-black">{Text}</p>
    </Link>
  </li>);
}
