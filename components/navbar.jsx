...
function Navbar() {
    ...
    return (<nav className="px-2 sm:px-4 py-2.5 transition dark:bg-gray-900 bg-white fixed w-full z-20 top-0 left-0 border-b border-gray-200 dark:border-gray-600">
    <div className="container flex flex-wrap justify-between items-center mx-auto">
        <a href="https://viratwiz.com/" className="flex items-center hover:no-underline dark:invert-0 dark:invert transition">
        ...
        <ul className="flex flex-col p-4 mt-4 bg-inherit rounded-lg border border-gray-100 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
            ...
            <button onClick={() => setTheme(theme === 'dark' ? 'light' : 'dark')} className="dark:text-white text-black">
                toggle
            </button>
        </ul>
        </div>
